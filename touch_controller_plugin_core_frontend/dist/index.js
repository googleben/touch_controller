...
class WebsocketButton extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    render() {
        let onc = () => {
            this.props.globalInfo.getWebsocket().send(this.props.onClickWs);
        };
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { href: "#", style: { padding: "2px", border: "1px solid black", borderRadius: "5px", cursor: "pointer" } }, this.props.text));
    }
}
let ps = { "WebsocketButton": WebsocketButton };
